...
import argparse
import logging
from aad.solutions.lane_detection.camera_geometry import CameraGeometry as sln_CameraGeometry
...
def test_project_polyline(boundary, trafo_world_to_cam, K):
    from aad.exercises.lane_detection.camera_geometry import project_polyline as ex_project_polyline
    from aad.solutions.lane_detection.camera_geometry import project_polyline as sln_project_polyline
...
def test_get_intrinsic_matrix():
    from aad.exercises.lane_detection.camera_geometry import get_intrinsic_matrix as ex_get_intrinsic_matrix
    from aad.solutions.lane_detection.camera_geometry import get_intrinsic_matrix as sln_get_intrinsic_matrix
...
if __name__ == "__main__":
    ...
    # Test exercise 2
    if step == 2:
        from aad.exercises.lane_detection.camera_geometry import CameraGeometry as ex_CameraGeometry
